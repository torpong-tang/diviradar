...
เอกสารนี้สรุปสถานะเชิงผลิตภัณฑ์ของ DiviRadar หลังจากเพิ่ม Watchlist, Portfolio, Dividend Calendar, XD History by Month, LINE OA Flex Message, cron auto price update และ production deployment บน 2Startup Cloud
...
- มี LINE OA Flex Message สำหรับ Daily Radar พร้อมราคา, score, yield และสถานะหุ้น
...
5. Add log retention rule for notification and cron logs
...
3. Add alert history and last-triggered timestamp
